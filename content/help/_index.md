...
<!--Main Hero Container-->
{{< hextra/hero-container cols="2" image="/images/homepage/hero.webp" imageWidth="500" style="padding: 24px; box-shadow: 0px 0px 2px inset; background-image: url(/images/homepage/container_pattern.webp); border-radius: 24px;">}}
