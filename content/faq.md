...
{{< hextra/hero-section heading="h3" >}}Regarding The Website{{< /hextra/hero-section >}}
{{< details title="Q. You used to have a website powered by MkDocs Materials, why replace it with Hugo and Hextra?" closed="true" >}}
...
{{< /details >}}
{{< details title="Q. Will this site be mostly focused on the blog in the future?" closed="true">}}
...
{{< /details >}}
{{< details title="Q. How often the site is updated?" closed="true">}}
...
{{< hextra/hero-section heading="h3" >}}Regarding Our Content{{< /hextra/hero-section >}}
{{< details title="Q. What is your stance on AI content?" closed="true">}}
  ![LessAIMoreHuman](/images/aistance.png)
...
{{< /details >}}
{{< details title="Q. Are you open for paid art commissions or such??" closed="true" >}}
...
{{< /details >}}
{{< details title="Q. What are the software and tools you use to create (branding, art, design, etc.)?" closed="true" >}}
  All of the content is created with Procreate for the illustrations, Figma for the branding and design. For other content such as publishing posts and such, I use Obsidian and Visual Studio Code. For hardware, I use an iPad and MacBook Air to do everything!
{{< /details >}}
